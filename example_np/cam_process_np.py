...
def process_sample(sample_number, sp, _read_id, fast5_file, random_matrix_numpy, reference_array_numpy, reference_array_comp_numpy, col, Threshold, sub_array_row, n_blocks, thresholds):
    ...
    for threshold in thresholds:
        ...
        if (event_length-col>0):
            final_location, final_location_comp, votes, votes_comp = process_event(sample_number,random_matrix_numpy, event, reference_array_numpy, reference_array_comp_numpy, col, Threshold, sub_array_row, n_blocks, event_length)
        else:
            final_location = 'N'
...
def update_position(sample_number, position, direction, search_time, vote_location, sp, read_id, fast5_file, index, thresholds, random_matrix_numpy, reference_array_numpy, reference_array_comp_numpy, col, Threshold, sub_array_row, n_blocks):
    """
    ...
    - random_matrix_numpy, reference_array_numpy, reference_array_comp_numpy: Tensors used
